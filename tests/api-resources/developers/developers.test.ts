...
describe('resource developers', () => {
  ...
  test.skip('login: only required params', async () => {
    const responsePromise = client.developers.login({ email: 'developer@example.com', password: 'MySecurePass123!' });
  ...
  test.skip('login: required and optional params', async () => {
    const response = await client.developers.login({ email: 'developer@example.com', password: 'MySecurePass123!' });
  });
