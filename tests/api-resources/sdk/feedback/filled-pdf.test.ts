...
describe('resource filledPdf', () => {
  ...
  test.skip('getVersionHistory: only required params', async () => {
    const responsePromise = client.sdk.feedback.filledPdf.getVersionHistory({ pdf_id: 'pdf_id', session_id: 'session_id' });
  ...
  test.skip('getVersionHistory: required and optional params', async () => {
    const response = await client.sdk.feedback.filledPdf.getVersionHistory({ pdf_id: 'pdf_id', session_id: 'session_id' });
  });
